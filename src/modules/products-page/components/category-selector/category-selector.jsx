  ...
  return (
    <div className={styles.wrapper__sidebar}>
      <nav className={styles.sidebar}>
          ...
          <div onClick={handleShowAllCategories} className={styles.title}>Показати категорії</div>
          ...
          <ul>
            ...
            <li onClick={() => handleMenuClick(1)}>
              ...
              <ul className={openMenuIndex === 1 ? styles.show : styles.hide}>
                <li onClick={() => onCategorySelect("Patchi")}>
                  Патчі під очі
                </li>
                <li onClick={() => onCategorySelect("Mask")}>Маска для лиця</li>
                <li onClick={() => onCategorySelect("Serum")}>
                  Сироватка для лиця
                </li>
                <li onClick={() => onCategorySelect("FaceScrub")}>
                  Скраб для лиця
                </li>
              </ul>
            </li>
